...
$buchstaben = $text;
	...
	$text = preg_replace('{(?:^|(?<=[аийоуыеeёАИЙОУЫЕЁЬьЪъ]))ѣ}','ye', $text);
    $text = str_replace('ЙА', 'Y·A', $text);
    $text = str_replace('ЙУ', 'Y·U', $text);
    $text = str_replace('ЙЫ', 'Y·Y', $text);
    $text = str_replace('ЙЭ', 'Y·E', $text);
    $text = str_replace('Йа', 'Y·a', $text);
    $text = str_replace('Йу', 'Y·u', $text);
    $text = str_replace('Йы', 'Y·y', $text);
    $text = str_replace('Йэ', 'Y·e', $text);
    ...
    $text = str_replace('йы', 'y·y', $text);
    $text = str_replace('йэ', 'y·e', $text);
    $text = str_replace('ЫА', 'Y·A', $text);
    $text = str_replace('ЫУ', 'Y·U', $text);
    $text = str_replace('ЫЫ', 'Y·Y', $text);
    $text = str_replace('ЫЭ', 'Y·E', $text);
    $text = str_replace('Ыа', 'Y·a', $text);
    $text = str_replace('Ыу', 'Y·u', $text);
    $text = str_replace('Ыы', 'Y·y', $text);
    $text = str_replace('Ыэ', 'Y·e', $text);
    ...
    $text = str_replace('ыы', 'y·y', $text);
    $text = str_replace('ыэ', 'y·e', $text);
	$text = preg_replace('{(?<=[ЦКНГШЩЗХФВПРЛДЖЧСМИТБцкнгшщзхфвпрлджчсмтб])Э}','·E', $text);
	$text = preg_replace('{(?<=[ЦКНГШЩЗХФВПРЛДЖЧСМИТБцкнгшщзхфвпрлджчсмтб])э}','·e', $text);
    $text = str_replace('Тс', 'T·s', $text);
    $text = str_replace('ТС', 'T·S', $text);
    $text = str_replace('тс', 't·s', $text);
    $text = str_replace('Шч', 'Sh·ch', $text);
    $text = str_replace('ШЧ', 'SH·CH', $text);
    $text = str_replace('шч', 'sh·ch', $text);
