...
$buchstaben = $text;
    ...
    $text = str_replace('Yu', 'Ю', $text);
    $text = str_replace('yu', 'ю', $text);   
    $text = str_replace('Ü', 'Ю', $text);
    $text = str_replace('ü', 'ю', $text);  
    $text = str_replace('YA', 'Я', $text);
    $text = str_replace('Ya', 'Я', $text);
    $text = str_replace('ya', 'я', $text);
    $text = str_replace('Q', 'Я', $text);
    $text = str_replace('q', 'я', $text);
    $text = str_replace('Je', 'Е', $text);
    $text = str_replace('JE', 'Е', $text);
    $text = str_replace('je', 'е', $text);
    $text = str_replace('Ä', 'Э', $text);
    $text = str_replace('ö', 'ё', $text);  
    $text = str_replace('Ö', 'Ё', $text);
    $text = str_replace('ä', 'э', $text); 
    $text = str_replace('Shch', 'Щ', $text);
    $text = str_replace('SHCH', 'Щ', $text);
    $text = str_replace('shch', 'щ', $text);
    $text = str_replace('Jo', 'Ё', $text);
    $text = str_replace('JO', 'Ё', $text);
